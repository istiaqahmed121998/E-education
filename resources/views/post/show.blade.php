...
<div class="col-md-9 mobile-space">
        ...
        <div class="card-body text-dark">
            ...
            <div class="entry-footer clearfix">
                <div class="mb-2 float-left">
                    ...
                    <ul class="cats">
                        <li><a href="{{ route('course.show',['course'=>$post->postable->course]) }}">{{ $post->postable->course->name }}</a></li>
                    </ul>
                </div>
    ...
    <div class="card border-primary mb-3 d-md-none d-lg-none d-xl-none">
        ...
        <div class="card-body text-dark d-flex justify-content-between">
            <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('post.show',['post'=>$post]) }}" target="_blank"
            ...
            <a href="whatsapp://send?text={{ route('post.show',['post'=>$post]) }}" target="_blank" rel="noreferrer"
            ...
            <a href="https://twitter.com/intent/tweet?text={{ $post->title }}&amp;url={{ route('post.show',['post'=>$post]) }}" target="_blank"
...
<div class="d-flex flex-column p-3 bg-light mb-3 bg-body shadow-lg rounded-3">
    ...
    <ul class="list-group list-group-flush rounded-3">
        ...
        <li class="list-group-item bg-primary border border-light">
            <a href="https://t.me/share/url?url={{ route('post.show',['post'=>$post]) }}&text={{ $post->title }}" target="_blank"
                rel="noreferrer" class="fw-bold text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    fill="currentColor" class="bi bi-telegram me-2" viewBox="0 0 16 16">
                    <path
        ...
        <li class="list-group-item bg-primary border border-light">
            <a href="https://twitter.com/intent/tweet?text={{ $post->title }}&amp;url={{ route('post.show',['post'=>$post]) }}"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    fill="currentColor" class="bi bi-twitter me-2" viewBox="0 0 16 16">
                    <path
                        d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z" />
                </svg>
                Twitter
